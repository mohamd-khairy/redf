<template>
  <div v-if="!removed" :style="{'height': height}" class="element row"
    ...
    <textarea v-else type="text" class="form-control ml-5 p-5" v-model="fill"
              :required="required" :class="{'border-danger': showRequiredNotify&&required&&!fill}"
              :disabled="reviewing||!enabled"></textarea>
