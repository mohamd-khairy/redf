...
<template>
    <div class="d-flex flex-column flex-grow-1">
        <v-btn color="primary" class="py-3 mb-2" @click="dialog = true">{{ $t('transactions.new_transaction') }}</v-btn>
                ...
                <v-row class="py-0 px-2" align="center">
                    ...
                    <v-col cols="8" class="py-0">
                        <div class="sm-cards">
                            ...
                            <div class="sm-crd py-1"><span>رقم المعاملة</span>
                                <h5>{{ treat.treatment_number ? treat.treatment_number : "-" }}</h5>
                            </div>
                            <div class="sm-crd py-1"><span>تاريخ المعاملة</span>
                                <h5>{{ treat.date ? treat.date : "-" }}</h5>
                            </div>
                            <div class="sm-crd py-1"><span>نوع المعاملة</span>
                                <h5>{{ treat.type ? treat.type : "-" }}</h5>
                            </div>
                            <div class="sm-crd py-1"><span>الإدارة</span>
